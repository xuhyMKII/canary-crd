...
//这个文件定义了微服务的数据结构，包括 MicroService 和 MicroServiceList。MicroService 结构体包含了微服务的元数据、规格和状态，
//而 MicroServiceList 结构体则是 MicroService 的列表。这些定义也用于 Kubernetes 中的自定义资源定义（CRD）。
